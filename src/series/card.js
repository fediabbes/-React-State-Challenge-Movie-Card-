...
function Listmovies({el}) {
  return (
    <div>
      <Card style={{ backgroundColor:'black', width: "15rem",textAlign:'center',boxShadow:'1px 1px 1px 1px', borderWidth:'15px'}}>
        ...
        <Card.Body>
          ...
          <Card.Text style={{textAlign:"center", fontFamily:"monospace",color:'rgb(158, 158, 158)'}}>{el.description}</Card.Text>
        </Card.Body>
        <ListGroup className="list-group-flush">
          <ListGroupItem style={{backgroundColor:'black',color:'rgb(158, 158, 158)'}}>{el.id}</ListGroupItem>
          <ListGroupItem style={{backgroundColor:'black',color:'rgb(158, 158, 158)'}}>{el.rate}</ListGroupItem>
